...
export default function EarthRotating({ size, className = "" }: Props) {
  return (
    <div 
      className={`pointer-events-none select-none relative ${className} drop-shadow-[0_0_35px_rgba(66,148,254,0.45)]`} 
    ...
    >
      ...
      >
        <defs>
          ...
          <radialGradient id="earth-shading" cx="30%" cy="30%" r="70%">
        ...
        {/* Capa atmosférica externa / brillo */}
        ...
        <g clipPath="url(#earth-clip)">
          ...
          {/* NUBES */}
          <g>
            <g id="clouds" fill="#e6ebfc" opacity="0.9">
          ...
          {/* Máscara de sombreado de esfera 3D */}
          <circle cx="175" cy="175" r="157" fill="url(#earth-shading)" />
        </g>
      </svg>
    </div>
  );
